...
public sealed class UpdateCandidateReferenceCommandValidator : AbstractValidator<UpdateCandidateReferenceCommand>
{
    public UpdateCandidateReferenceCommandValidator()
    {
