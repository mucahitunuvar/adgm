...
public sealed class RemoveCandidateReferenceCommandHandler(
    ...
    : IRequestHandler<RemoveCandidateReferenceCommand, Result>
{
    public async Task<Result> Handle(RemoveCandidateReferenceCommand request, CancellationToken cancellationToken)
    {
        ...
        content.RemoveReference(request.CandidateReferenceId);
