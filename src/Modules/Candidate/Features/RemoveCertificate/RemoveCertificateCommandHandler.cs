...
public sealed class RemoveCertificateCommandHandler(
    ...
    : IRequestHandler<RemoveCertificateCommand, Result>
{
    public async Task<Result> Handle(RemoveCertificateCommand request, CancellationToken cancellationToken)
    {
        ...
        content.RemoveCertificate(request.CertificateId);
