...
public sealed class RemoveCandidateLanguageCommandHandler(
    ...
    : IRequestHandler<RemoveCandidateLanguageCommand, Result>
{
    public async Task<Result> Handle(RemoveCandidateLanguageCommand request, CancellationToken cancellationToken)
    {
        ...
        content.RemoveLanguage(request.CandidateLanguageId);
