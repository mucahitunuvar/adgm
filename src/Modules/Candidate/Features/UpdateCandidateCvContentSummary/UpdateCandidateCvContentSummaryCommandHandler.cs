...
public sealed class UpdateCandidateCvContentSummaryCommandHandler(
    ...
    : IRequestHandler<UpdateCandidateCvContentSummaryCommand, Result>
{
    public async Task<Result> Handle(UpdateCandidateCvContentSummaryCommand request, CancellationToken cancellationToken)
    {
        ...
        content.UpdateSummary(request.Summary);
        content.UpdateComputerSkills(request.ComputerSkills);
        content.UpdateHobbies(request.Hobbies);
