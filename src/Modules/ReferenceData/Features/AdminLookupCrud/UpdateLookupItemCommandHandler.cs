...
public sealed class UpdateLookupItemCommandHandler<TLookup>(
    ...
    : IRequestHandler<UpdateLookupItemCommand<TLookup>, Result>
    where TLookup : LookupItem, ILookupItemFactory<TLookup>
{
    public async Task<Result> Handle(UpdateLookupItemCommand<TLookup> request, CancellationToken cancellationToken)
    {
