...
// 100'lük sistem.
public sealed class DiplomaGradingSystem : LookupItem, ILookupItemFactory<DiplomaGradingSystem>
{
    ...
    public static ReferenceDataLookupType LookupType => ReferenceDataLookupType.DiplomaGradingSystem;
