...
public sealed class LanguageLevel : LookupItem, ILookupItemFactory<LanguageLevel>
{
    ...
    public static ReferenceDataLookupType LookupType => ReferenceDataLookupType.LanguageLevel;
