...
public sealed class Department : LookupItem, ILookupItemFactory<Department>
{
    ...
    public static ReferenceDataLookupType LookupType => ReferenceDataLookupType.Department;
