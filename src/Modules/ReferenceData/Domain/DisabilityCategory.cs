...
// kategorisi.
public sealed class DisabilityCategory : LookupItem, ILookupItemFactory<DisabilityCategory>
{
    ...
    public static ReferenceDataLookupType LookupType => ReferenceDataLookupType.DisabilityCategory;
